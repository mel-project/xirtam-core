...
nullpoint-crypt provides small, opinionated wrappers around common crypto primitives with consistent construction and serialization (including human-readable JSON via unpadded base64url).
...
```rust
use nullpoint_crypt::signing::SigningSecret;
