...
nullpoint-dirclient provides a small, opinionated client for the Nullpoint directory RPC. It caches headers locally and verifies SMT proofs against the signed trust anchor.
