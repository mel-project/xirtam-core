...
- [**Novel end-to-end encryption system**](protocol/e2ee.md) that avoids "ratcheting" to achieve better performance and robustness, plus a much simpler implementation. E2EE is always-on and performant, even for large groups.
