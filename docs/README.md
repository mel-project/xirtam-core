...
Xirtam (this name is provisional!) is a **confederal** end-to-end chat system. A confederal protocol shares two similarities with a federated protocol like Matrix:
