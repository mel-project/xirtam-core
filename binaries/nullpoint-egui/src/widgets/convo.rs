...
use tracing::debug;
use nullpoint_client::internal::{ConvoId, ConvoMessage};
use nullpoint_structs::group::{GroupId, GroupInviteMsg};
use nullpoint_structs::event::EventPayload;
...
pub struct Convo<'a>(pub &'a mut NullpointApp, pub ConvoId);
...
fn send_message(ui: &mut eframe::egui::Ui, app: &mut NullpointApp, convo_id: &ConvoId, body: Bytes) {
    let rpc = app.client.rpc();
...
fn render_row(ui: &mut eframe::egui::Ui, item: &ConvoMessage, app: &mut NullpointApp) {
