...
use nullpoint_client::internal::{ConvoId, ConvoSummary};
...
pub struct SteadyState<'a>(pub &'a mut NullpointApp);
...
fn short_group_id(group: &nullpoint_structs::group::GroupId) -> String {
